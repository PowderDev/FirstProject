...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
function slider({container, slide, newtArrow, prewArraw, totalCounter, currentCounter, wrapper, field}) {
    // Slider
    ...
    const slides = document.querySelectorAll(slide),
        ...
        prev = document.querySelector(prewArraw),
        next = document.querySelector(newtArrow),
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021.1.01');
    ...
    (0,_modules_slider__WEBPACK_IMPORTED_MODULE_6__.default)({
        ...
        slide: '.offer__slide',
        newtArrow: '.offer__slider-next',
        prewArraw: '.offer__slider-prev',
        totalCounter: '#total',
